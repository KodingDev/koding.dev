      ...
      <div className="layout-container flex h-[calc(100svh-6rem)]">
        <div className="relative my-auto 2xl:w-2/3">
          ...
          <Header emoji="👋" title="Hi, I'm Stella">
            ...
            <span className="whitespace-nowrap rounded-xl bg-primary-200 px-2 py-1">8 years</span>.
          </Header>
          ...
          <div className="hidden sm:block">
            ...
            <div className="absolute top-[7.5rem] left-0">
              <TwinklingStar>
            ...
            <div className="-left-12 absolute bottom-14">
              <TwinklingStar>
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <title>Star</title>
                  <path
