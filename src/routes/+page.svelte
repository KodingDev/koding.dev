...
<div class="layout-container flex h-[calc(100vh-6rem)]">
  <div class="relative my-auto 2xl:w-2/3">
    ...
    <div class="hidden sm:block">
      ...
      <svg class="absolute top-10 right-0" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg class="absolute top-[8.5rem] left-0" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg class="absolute -left-12 bottom-14" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg class="absolute bottom-16 right-16" width="26" height="32" viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
<div class="layout-container pb-36">
  ...
  {#each Array(3) as _, i}
    <div class="flex flex-row items-center gap-8 border-b border-white/25 py-12">
      <!-- TODO: Dropdown arrow -->
      <!-- Dropdown Arrow -->
      <span class="h-6 w-6 opacity-50"><FaChevronDown /></span>
      ...
      <div class="flex w-1/4 flex-col gap-3">
        <div class="flex flex-row items-center">
          ...
          <!-- Date -->
          <span class="pl-2 opacity-75">2021 - Now</span>
        </div>

        <div class="flex flex-row items-center">
          <!-- Client Logo -->
          <img class="h-11 w-11 rounded-xl" src="https://avatars.githubusercontent.com/u/89606108?s=200&v=4" alt="Company Logo" />

          <!-- Project name -->
          <h1 class="pl-4 text-2xl font-bold">MC Party</h1>
      ...
      <!-- Description -->
      <span class=" flex-1 opacity-50"
        >Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore
        veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia volupta.</span
      >
    </div>
  {/each}
</div>
